...
// PURPOSE:         This page is the view for the input portion of the site. 
//                  The input portion takes user information including
//                  name, bacteria, file to upload, etc and sends the
//                  data on to but checked, uploaded and parsed. (3 php
//                  classes for doing that).
// NOTES:           this page is used for mockups for input
//                  before they go live.
//////////////////////////////////////////////
...
<section id="mainarea">
  ...
  <div id="description" >
    ...
    <p id="error" style="color: red;"><?php if (isset($_REQUEST['inputError'])) echo $_REQUEST['inputError']; ?></p>
    <p id="success" style="color: green;"><?php if (isset($_REQUEST['success'])) echo $_REQUEST['success']; ?></p>
  </div><!-- /#description -->

  <?php /* OLD ERROR REPORTING
  <div id="description" >
    <p>Please select the file type, the bacterial ID, the plate type and add any additional information.  Plates associated with the viral dark matter project should be "multi-plate reader."</p>
    <p id="error"><?php if (isset($_REQUEST['inputError'])) echo $_REQUEST['inputError']; ?></p>
    <p id="success" style="color: green;"><?php //if (isset($_REQUEST['success'])) echo $_REQUEST['success']; ?></p>
  </div><!-- /#description -->
  */ ?>

  <form id="inputUploadForm" action="input_uploader_test2.php" method="post" enctype="multipart/form-data">
  <div id="leftCol">
