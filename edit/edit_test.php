	...
	$(function() { 
		...
		$("#addclone").click(function() {
			...
			if(bact_external_id.length>0) {
				...
				alert('Bacteria External ID is a required field.');
			}
		});
	});
</script>
			...
			<table width="400">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input class="holder" placeholder="e.g. EDT0000" name="bact_external_id" id="bact_external_id">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input class="holder" placeholder="e.g. Escherichia coli" name="bact_name" id="bact_name">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input class="holder" placeholder="e.g. 5432" name="vc_id" id="vc_id">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input class="holder" placeholder="e.g. pEMB11" name="vector" id="vector">
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input class="holder" name="genotype" id="genotype">
						</td>
					</tr>
					<tr>
						<td>
							<input id="addclone" type="submit" value="Add clone" onclick="return false">
						</td>
					</tr>
				</tbody>
			</table>
