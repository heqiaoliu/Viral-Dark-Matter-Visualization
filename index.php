...
require "div_nav.html";?>
<section id="mainarea">
	<article id="description" >
		<h1>Viral Dark Matter Project</h1>
		<p>
			This website is designed for data input and visualization for the viral dark matter project.  Start with the input page if you have data to upload, or go straight to view to see existing data in the database.  
		</p>
		<h3>View</h3>
		<p>Page "View" provides function of PM data visualization </p>
		<h3>Rosetta</h3>
		<p>Page "Rosetta" provides a quick look of internal and external data of the site</p>
		<h5>Input & Edit requires user login.</h5>
